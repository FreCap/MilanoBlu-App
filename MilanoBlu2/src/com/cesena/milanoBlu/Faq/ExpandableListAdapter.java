...
import com.cesenaTeam.milanoBlu.R.drawable;
...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
	...
	private int getBackground(int id) {
		switch (id % 5) {
		case 0:
		...
		case 2:
			return R.drawable.background_grey;
		case 3:
			return R.drawable.background_magenta;
		case 4:
...
//
//		LinearLayout layoutItem = (LinearLayout) convertView
//				.findViewById(R.id.faq_list_group);
//
//		layoutItem.setBackgroundResource(getBackground(groupPosition));
